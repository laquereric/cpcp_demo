...
Loads demo/push-note.cid.json and demo/pull-note.cid.json, then drives
...
@context. Anything here failing means the demo drifted from its own CIDs.

Usage:  PORT=18080 python3 demo/conform.py   (server must be running)
